        ...
        <div className="row px-xl-5">
              ...
              <div className="carousel-inner">
                ...
                >
                  <img
                    ...
                    src="assesst/img/carousel-1.jpg"
                    alt="Carousel 1"
                ...
                >
                  <img
                    className="position-absolute w-100 h-100"
                    src="assesst/img/carousel-2.jpg"
                    alt="Carousel 2"
                    style={{ objectFit: "cover" }}
                  />
                  <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                ...
                >
                  <img
                    className="position-absolute w-100 h-100"
                    src="assesst/img/carousel-3.jpg"
                    alt="Carousel 3"
                    style={{ objectFit: "cover" }}
                  />
                  <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
          ...
          <div className="col-lg-4">
            <div className="product-offer mb-30" style={{ height: "200px" }}>
              <img className="img-fluid" src="assesst/img/offer-1.jpg" alt="Offer 1" />
            ...
            <div className="product-offer mb-30" style={{ height: "200px" }}>
              <img className="img-fluid" src="assesst/img/offer-2.jpg" alt="Offer 2" />
              <div className="offer-text">
                <h6 className="text-white text-uppercase">Save 20%</h6>
                <h3 className="text-white mb-3">Special Offer</h3>
                <a href="#" className="btn btn-primary">
